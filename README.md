...
*(Опционально)* Может содержать название города(из списка).  
...
### Логи
Если после любого сообщения ввести через пробел vdhfzvasdv123, то будет возвращен расширенный ответ с логами.
